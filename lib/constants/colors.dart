...
final limeBGColor = Colors.lime;
final redColor = Colors.red;
final fullWhiteColor = Colors.white;
final lastColor = Color(0xFFFDF7EF);
final blackFontColor = Color.fromARGB(255, 26, 1, 1);
final textFieldColor = Color.fromARGB(71, 255, 248, 237);
final font_bgOrange = Color.fromARGB(255, 24, 24, 23);
final green_bg = Color.fromARGB(255, 224, 255, 238);
