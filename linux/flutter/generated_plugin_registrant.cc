...
#include <firebase_core_desktop/none.h>
...
void fl_register_plugins(FlPluginRegistry* registry) {
  ...
  g_autoptr(FlPluginRegistrar) firebase_core_desktop_registrar =
      fl_plugin_registry_get_registrar_for_plugin(registry, "none");
  none_register_with_registrar(firebase_core_desktop_registrar);
